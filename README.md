[![image charts swift library logo](./logo.jpg)](#getting-started)
...
![Libraries.io dependency status for GitHub repo](https://img.shields.io/librariesio/github/image-charts/swift)
![Code Climate maintainability](https://img.shields.io/codeclimate/maintainability/image-charts/swift)
...
#### 1. Add Image-Charts Swift Package

Add the following to your `Package.swift`:

```swift
dependencies: [
    .package(url: "https://github.com/image-charts/swift.git", from: "1.0.0")
]
```

Or in Xcode: File > Add Packages... > Enter: `https://github.com/image-charts/swift`
...
print(pie.toURL()) // https://image-charts.com/chart?chd=a%3A2.5%2C5%2C8.3&chs=100x100&cht=p

// Using async/await (iOS 13+, macOS 10.15+)
Task {
    let dataURI = try await pie.toDataURI()
    print(dataURI) // data:image/png;base64,iVBORw0KGgo...

    let data = try await pie.toData()
    print(data.count) // bytes count

    try await pie.toFile("/path/to/chart.png")
}

// Using completion handlers
pie.toData { result in
    switch result {
...
// With secret key (Enterprise & Enterprise+)
let chart = ImageCharts(secret: "SECRET_KEY")

// With timeout
let chart = ImageCharts(secret: "SECRET_KEY", timeout: 10.0)

// Full configuration (On-Premise)
let chart = ImageCharts(
    protocol: "https",
...
|--------|------|---------|-------------|
| `protocol` | `String?` | `"https"` | (On-Premise only) custom protocol |
| `host` | `String?` | `"image-charts.com"` | (Enterprise+, On-Premise) custom domain |
| `port` | `Int?` | `443` | (On-Premise only) custom port |
| `pathname` | `String?` | `"/chart"` | (On-Premise only) custom pathname |
| `secret` | `String?` | `nil` | (Enterprise, Enterprise+) SECRET_KEY |
| `timeout` | `TimeInterval?` | `5` | Request timeout in seconds |
...
<a name="tofile"></a>
#### `toFile(_ path: String)` -> `Void`

> Creates a file containing the generated chart image
...
// Using async/await (iOS 13+, macOS 10.15+)
Task {
    try await chart.toFile("/path/to/chart.png")
    print("Chart saved successfully!")
}

```

##### Usage (completion handler)
...
let chartURL = ImageCharts(secret: "SECRET_KEY")
    .icac("ACCOUNT_ID")
    .cht("p3") // pie chart
...
print(chartURL)
// https://image-charts.com/chart?chd=t%3A60%2C40&chf=ps0-0%2Clg%2C45%2Cffeb3b%2C0.2%2Cf44336%2C1%7Cps0-1%2Clg%2C45%2C8bc34a%2C0.2%2C009688%2C1&chl=Hello%7CWorld&chs=700x190&cht=p3&icac=documentation&icretina=1&ichm=...
...
<a name="cht"></a>
#### `cht(_ value: String)` -> `ImageCharts`
...
<a name="chd"></a>
#### `chd(_ value: String)` -> `ImageCharts`
...
<a name="chds"></a>
#### `chds(_ value: String)` -> `ImageCharts`
...
<a name="choe"></a>
#### `choe(_ value: String)` -> `ImageCharts`
...
<a name="chld"></a>
#### `chld(_ value: String)` -> `ImageCharts`
...
<a name="chxr"></a>
#### `chxr(_ value: String)` -> `ImageCharts`
...
<a name="chof"></a>
#### `chof(_ value: String)` -> `ImageCharts`
...
<a name="chs"></a>
#### `chs(_ value: String)` -> `ImageCharts`
...
<a name="chdl"></a>
#### `chdl(_ value: String)` -> `ImageCharts`
...
<a name="chdls"></a>
#### `chdls(_ value: String)` -> `ImageCharts`
...
<a name="chg"></a>
#### `chg(_ value: String)` -> `ImageCharts`
...
<a name="chco"></a>
#### `chco(_ value: String)` -> `ImageCharts`
...
<a name="chtt"></a>
#### `chtt(_ value: String)` -> `ImageCharts`
...
<a name="chts"></a>
#### `chts(_ value: String)` -> `ImageCharts`
...
<a name="chxt"></a>
#### `chxt(_ value: String)` -> `ImageCharts`
...
<a name="chxl"></a>
#### `chxl(_ value: String)` -> `ImageCharts`
...
<a name="chxs"></a>
#### `chxs(_ value: String)` -> `ImageCharts`
...
<a name="chm"></a>
#### `chm(_ value: String)` -> `ImageCharts`
...
<a name="chls"></a>
#### `chls(_ value: String)` -> `ImageCharts`
...
<a name="chl"></a>
#### `chl(_ value: String)` -> `ImageCharts`
...
<a name="chlps"></a>
#### `chlps(_ value: String)` -> `ImageCharts`
...
<a name="chma"></a>
#### `chma(_ value: String)` -> `ImageCharts`
...
<a name="chdlp"></a>
#### `chdlp(_ value: String)` -> `ImageCharts`
...
<a name="chf"></a>
#### `chf(_ value: String)` -> `ImageCharts`
...
<a name="chbr"></a>
#### `chbr(_ value: String)` -> `ImageCharts`
...
<a name="chan"></a>
#### `chan(_ value: String)` -> `ImageCharts`
...
<a name="chli"></a>
#### `chli(_ value: String)` -> `ImageCharts`
...
<a name="icac"></a>
#### `icac(_ value: String)` -> `ImageCharts`
...
<a name="ichm"></a>
#### `ichm(_ value: String)` -> `ImageCharts`
...
<a name="icff"></a>
#### `icff(_ value: String)` -> `ImageCharts`
...
<a name="icfs"></a>
#### `icfs(_ value: String)` -> `ImageCharts`
...
<a name="iclocale"></a>
#### `iclocale(_ value: String)` -> `ImageCharts`
...
<a name="icretina"></a>
#### `icretina(_ value: String)` -> `ImageCharts`
...
<a name="icqrb"></a>
#### `icqrb(_ value: String)` -> `ImageCharts`
...
<a name="icqrf"></a>
#### `icqrf(_ value: String)` -> `ImageCharts`
